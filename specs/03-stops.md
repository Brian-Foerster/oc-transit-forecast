...
- Project mode (decision 2026-07-08): **elevated automated light metro**
  — fixed guideway, which is STOPS's designed use case (a better fit
  than the earlier BRT framing); build GTFS coded as rail mode, with
  stop_times generated by the spec 02 §4.9 grade-separated speed model
  (spec 04 §3.1 shares the same function for fleet sizing).
