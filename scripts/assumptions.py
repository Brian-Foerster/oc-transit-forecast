...
ASSUMPTIONS = {
    ...
    # spec 01 §9 v2.1 fit-side DATA entries. Phase 2b LANDED 2026-07-21
    # (outputs/screen_results_v21.json): these dispositions flipped from
    # spec-pending:01§9 to covered-elsewhere:<row> -- each vintage-matched
    # data input's materiality is exercised by the v2.1 battery row that swaps
    # its predictor (LODES flows -> popden_swap; WAC jobs -> gen_dummy_swap;
    # ACS zero-veh HH -> e002_swap; block frame / apportionment -> buffer_lo).
    ...
    "lodes_od_2017": {
        ...
        "rows": {}, "no_row_reason": "covered-elsewhere:popden_swap",
        "accepted": ("spec01 §9 pre-registration 2026-07-20", "2026-07-20"),
        "logged": None,
    ...
    "tiger2020pl_blocks": {
        ...
        "rows": {}, "no_row_reason": "covered-elsewhere:buffer_lo",
        "accepted": ("spec01 §9 pre-registration 2026-07-20", "2026-07-20"),
        "logged": None,
    ...
    "acs_2017_5yr": {
        ...
        "provenance": "Census ACS 2013-2017 5-yr summary file, CA tract "
                      ...
                      "screen_common_v21",
        "rows": {}, "no_row_reason": "covered-elsewhere:e002_swap",
        "accepted": ("spec01 §9 pre-registration 2026-07-20", "2026-07-20"),
        "logged": None,
        "upgrade": "phase 2b rebuilt fit (vintage-matched battery rows)",
    },
